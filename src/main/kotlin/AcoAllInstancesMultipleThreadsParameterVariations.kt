    ...
    while (true) {
        ...
        for (instanceId in 1..6) {
            ...
            val alpha = thread(name = "alpha") {
                ...
                cAlpha.ant.alpha = Random().nextInt(0, 21).toDouble() / 10
            ...
            val beta = thread(name = "beta") {
                ...
                cBeta.ant.beta = Random().nextInt(0, 21).toDouble() / 10
            ...
            val count = thread(name = "count") {
                ...
                cCount.ant.count = Random().nextInt(1, 11) * 10
            ...
            val theta = thread(name = "theta") {
                ...
                cTheta.ant.theta = Random().nextInt(0, 11).toDouble() / 10
